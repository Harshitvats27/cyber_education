...
class CyberModule5 extends StatefulWidget {
  final String role;
  const CyberModule5({super.key, required this.role});

  @override
  State<CyberModule5> createState() => _CyberModule5State();
}

class _CyberModule5State extends State<CyberModule5> {
  String introduction = "";
  String videoUrl = "";
  ...
  Future<void> _loadModule() async {
    ...
    try {
      ...
      if (!doc.exists) {
        setState(() {
          errorMessage = "⚠️ Module 5 data not found in Firestore.";
          isLoading = false;
        });
        return;
      }
  ...
  Future<void> _markCompleted() async {
    ...
    final moduleName = "module5"; // module ka naam
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${widget.role} - Module 5"),
