...
class CyberModule2 extends StatefulWidget {
  final String role;
  const CyberModule2({super.key, required this.role});

  @override
  State<CyberModule2> createState() => _CyberModule2State();
}

class _CyberModule2State extends State<CyberModule2> {
  String introduction = "";
  String videoUrl = "";
  ...
  Future<void> _loadModule() async {
    ...
    try {
      ...
      if (!doc.exists) {
        setState(() {
          errorMessage = "⚠️ Module 2 data not found in Firestore.";
          isLoading = false;
        });
        return;
      }
    ...
    debugPrint("🔹 Loaded module2 for role: ${widget.role}, videoUrl: $videoUrl");
  }
  Future<void> _markCompleted() async {
    ...
    final moduleName = "module2"; // module ka naam
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${widget.role} - Module 2"),
